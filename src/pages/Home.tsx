            ...
            <Card className="flex-1 p-4 hover-lift cursor-pointer">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Hill Station packages from ₹8,999
                </p>
              </div>
            </Card>
            <Card className="flex-1 p-4 hover-lift cursor-pointer">
                ...
                >
                  <Link to={sector.link}>
                    <div className="relative h-48 overflow-hidden">
                      ...
                      <div
                        className={`absolute top-4 left-4 w-12 h-12 bg-${sector.color} rounded-full flex items-center justify-center shadow-medium`}
                      >
